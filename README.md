...
|---|---|---|
| **[E-Store Marketing Analytics](https://github.com/vbalalian/estore-analytics)** | Event-driven batch analytics pipeline for 400M+ ecommerce events to calculate customer churn, conversion metrics, and perform RFM analysis. | dbt · Dagster · GCP |
